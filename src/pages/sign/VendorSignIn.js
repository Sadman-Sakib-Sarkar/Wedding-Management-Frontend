    ...
    <>
      <div className="outer-box back-opacity p-2 p-4">
        <div className="text-center mt-2 text-dark">
          ...
          <p>Don’t have an account? <a href="/vendor-sign-up" className="text-danger">Free sign up</a></p>
        </div>
        ...
        <div className="text-center mt-3">
          <h6 className="text-secondary display-6">Are you a buyer?</h6>
          <a href="/sign-in" className="text-danger">Buyer Log in</a>
        </div>
      </div>
    </>
