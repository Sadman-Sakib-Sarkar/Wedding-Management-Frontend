  ...
  return (
    <>
      <div className="container">
        <h1 className="display-5 text-light">Wedding Videographers</h1>

        <div className="mt-4">
          <form className="form-inline">
            <input className="form-control mr-sm-2" type="search" placeholder="Wedding Videographers" aria-label="Search"/>
      ...
      <div className="container mt-5">
        ...
        <p className="text-secondary text-light ml-3 align-self-center d-inline">564 RESULTS</p>
      </div>
