  ...
  return (
    <>
      <div className="container">
        <h1 className="display-5 text-light">Bridal Lehenga Designers and Shops</h1>

        <div className="mt-4">
          <form className="form-inline">
            <input className="form-control mr-sm-2" type="search" placeholder="Bridal Lehenga" aria-label="Search"/>
      ...
      <div className="container mt-5">
        ...
        <p className="text-secondary text-light ml-3 align-self-center d-inline">2,124 RESULTS</p>
      </div>
